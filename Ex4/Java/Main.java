...
public class Main {
        ...
        public static void main(String[] args) throws IOException, InterruptedException {
                double[][] A = MatrixCSV.readMatrixFromCsv(
                                "C:\\Users\\daion\\OneDrive\\Документы\\Practice01\\Ex4\\Python\\matrix_a.csv");
                double[][] B = MatrixCSV.readMatrixFromCsv(
                                "C:\\Users\\daion\\OneDrive\\Документы\\Practice01\\Ex4\\Python\\matrix_b.csv");
                double[][] C = MatrixCSV.readMatrixFromCsv(
                                "C:\\Users\\daion\\OneDrive\\Документы\\Practice01\\Ex4\\Python\\matrix_c.csv");
                ...
                String resWithoutMultithreading = String.format("Time without multithreading: %.4f seconds",
                                TimeUnit.NANOSECONDS.toSeconds(elapsedTime) + (double) TimeUnit.NANOSECONDS
                                                .toNanos(elapsedTime % TimeUnit.SECONDS.toNanos(1))
